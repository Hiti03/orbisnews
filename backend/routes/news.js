...
const INTEREST_KEYWORDS = {
  ...
  ai:             'artificial intelligence AI machine learning ChatGPT LLM',
  stocks:         'stock market finance economy investment earnings',
  crypto:         'cryptocurrency bitcoin blockchain ethereum crypto web3',
  business:       'business company CEO corporate acquisition merger',
  startups:       'startup founder venture capital funding unicorn IPO',
  ...
  cricket:        'cricket IPL Test ODI BCCI bowler batsman wicket',
  football:       'football soccer FIFA Premier League Champions League goal',
  entertainment:  'entertainment movies music celebrity film',
  gaming:         'gaming video game esports PlayStation Xbox Nintendo Steam',
  music:          'music album artist singer concert Grammy tour release',
  ...
  realestate:     'real estate housing property mortgage rent market',
  education:      'education school university college student learning',
  law:            'law court justice judge verdict trial lawsuit legal',
  travel:         'travel tourism airline hotel visa destination flights',
  food:           'food restaurant cuisine chef recipe dining culinary',
  fashion:        'fashion style brand designer luxury clothing runway',
  automotive:     'automotive car electric vehicle EV Tesla manufacturer',
  humanrights:    'human rights protest activist democracy freedom civil',
  religion:       'religion faith church mosque temple spiritual society',
  culture:        'culture art museum exhibition heritage literature cinema',
};
...
const STRICT_KEYWORDS = {
  ...
  ai:             '"artificial intelligence" OR ChatGPT OR "machine learning" OR LLM OR OpenAI OR Gemini OR "generative AI"',
  stocks:         'stocks OR "stock market" OR earnings OR "interest rate" OR inflation OR GDP OR Sensex OR Nifty OR Nasdaq',
  crypto:         'bitcoin OR cryptocurrency OR blockchain OR ethereum OR crypto OR "Web3" OR NFT OR "digital currency"',
  business:       'business OR CEO OR corporate OR acquisition OR merger OR revenue OR quarterly OR "market cap"',
  startups:       'startup OR founder OR "venture capital" OR funding OR unicorn OR IPO OR "seed round" OR accelerator',
  ...
  cricket:        'cricket OR IPL OR "Test match" OR ODI OR BCCI OR wicket OR batsman OR bowler OR "World Cup cricket"',
  football:       'football OR soccer OR FIFA OR "Premier League" OR "Champions League" OR "World Cup" OR LaLiga OR Bundesliga',
  entertainment:  'entertainment OR movie OR film OR music OR celebrity OR Oscar OR Grammy OR Netflix OR "box office"',
  gaming:         'gaming OR "video game" OR esports OR PlayStation OR Xbox OR Nintendo OR Steam OR "game release"',
  music:          'music OR album OR concert OR Grammy OR tour OR "chart-topping" OR "music festival" OR singer OR rapper',
  ...
  realestate:     '"real estate" OR housing OR property OR mortgage OR "home prices" OR rent OR "housing market"',
  education:      'education OR university OR school OR college OR "tuition" OR "student loan" OR "academic" OR curriculum',
  law:            'court OR lawsuit OR verdict OR trial OR judge OR "Supreme Court" OR legislation OR "legal ruling"',
  travel:         'travel OR tourism OR airline OR "hotel" OR visa OR "travel ban" OR destination OR "flight prices"',
  food:           'food OR restaurant OR cuisine OR chef OR "food safety" OR "food prices" OR culinary OR dining',
  fashion:        'fashion OR style OR designer OR luxury OR clothing OR "fashion week" OR brand OR runway',
  automotive:     'automotive OR "electric vehicle" OR EV OR Tesla OR "car sales" OR manufacturer OR "self-driving"',
  humanrights:    '"human rights" OR protest OR activist OR democracy OR freedom OR "civil rights" OR oppression',
  religion:       'religion OR faith OR church OR mosque OR temple OR "religious" OR spiritual OR interfaith',
  culture:        'culture OR art OR museum OR exhibition OR heritage OR literature OR cinema OR "cultural"',
};
