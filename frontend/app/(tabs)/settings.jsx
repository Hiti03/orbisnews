...
function makeStyles(theme, insets = { top: 0 }) {
  return StyleSheet.create({
    ...
    interestEmoji: { fontSize: 15, flexShrink: 0 },
    interestLabel: { fontSize: 12, color: theme.text, flexShrink: 1 },
    interestLabelActive: { color: theme.primary, fontWeight: '600' },
    interestCheck: { color: theme.primary, fontWeight: 'bold', marginLeft: 2, flexShrink: 0 },
    saveBtn: {
